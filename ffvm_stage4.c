...
static void build_fc(char *fc, size_t cap) {
	static const char *re =
		...
		"))+st(8,if(max(max(max(eq(ld(2),1),eq(ld(2),16)),max(eq(ld(2),17),eq(ld(2),18))),max(max(eq(ld(2),48),eq(ld(2),49)),max("
		"eq(ld(2),32),eq(ld(2),33)))),2,1)))+if(gte(Y,192),r(X,Y),if(eq(Y,0),if(eq(ld(2),49)*eq(X,ld(3)),ld(6),if(eq(X,32),if(eq("
		"ld(2),16),ld(3),if(eq(ld(2),17),if(eq(ld(6),0),ld(3),ld(1)+2),if(eq(ld(2),18),if(eq(ld(6),0),ld(1)+2,ld(3)),if(eq(ld(2),"
		"0),ld(1),mod(ld(1)+ld(8),256))))),if(eq(X,33),if(max(max(eq(ld(2),1),eq(ld(2),3)),max(eq(ld(2),48),eq(ld(2),32))),ld(4)+"
...
int main(int argc, char **argv) {
	...
	const char *pa = "/tmp/s4a.ppm";
	const char *pb = "/tmp/s4b.ppm";
